...
import { addUserToStore, deleteUserStore, setCurrentUser, updateOrderInvoice, updateUserinStore } from './usersSlice.actions';
...
export const usersReducer = createReducer(
  ...
  on(deleteUserStore, (state: UsersState, { userId }) => ({
    ...state,
